...
public final class FileStream extends JavaScriptObject {
     ...
     * 
     * @return the current position of the read pointer in this stream
     */
    ...
    /**
     * Sets the position of the read pointer to a specific place in the stream
     * 
     * <p>If it is set to &lt; 0, the position will be 0.
     * If it is set to &lt; <code>{@link File#getFileSize()}</code>, the position will be <code>{@link File#getFileSize()}</code>.</p>
     * 
     * @param position the new position of the read pointer
     */
     ...
     * 
     * @return number of bytes available to be read from the current position
     */
    ...
    /**
     * Tests whether the end of the <code>FileStream</code> has been reached.
     *
     ...
     *
     * <p>To change the encoding of this stream, use {@link #setEncoding(String)}</p>
     */
	...
	/**
	 * <p>This property defaults to UTF-8. Change it to override the default encoding
     ...
     * {@link #readLine(String)} or {@link #writeLine(String)}.
     */
     ...
     * newline in the <code>FileStream</code> as defined by the {@link #getNewLine()} property. 
     ...
     *
     * @return A String of characters, or null if there are no data to read.
     * @throws IOEXception If it is not possible to read from the stream.
     */
     ...
     * the {@link #getNewLine()} property to the <code>FileStream</code>, using the given charset or the charset 
     * in {@link FileStream#getEncoding()}</code>.</p>
     *
     * <p class="ni">The <code>charset</code> argument is currently ignored.</p>
     *
     * @param string The string of characters to write.
