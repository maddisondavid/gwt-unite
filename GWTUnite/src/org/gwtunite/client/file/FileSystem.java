...
public final class FileSystem extends JavaScriptObject {
	...
	/** 
	 * Retrieve an instance of the VirtualFileSystem 
	 * 
	 * @return an instance of the VirtualFileSystem
	 * @throws FeatureUnavailableException if the filesystem feature has not been specified in the applications config.xml
	 */
     ...
     *
     * <p>This is a special {@link File}</code> object that represents the root of the virtual file
     ...
     * of the mount point is <code>/foo</code>.</p>
     * 
     * <p>To see all the mount points use {@link File#listFiles()}</p>
     * 
     * @return a virtual directory containing all current mount points
     */
     ...
     * files.</p>
     *
     * @return <code>File</code> object representing the mounted Application directory
     */
     ...
     *
     * @return <code>File</code> object representing the shared system directory
     */
     ...
     *
     * @return <code>File</code> object representing the mounted storage directory
     */
     ...
     * @throws IOException If the given File or String doesn't represent a mount point.
     */
